...
Authentication & Identity Intelligence (Phase 2E) - Utilities

Small, dependency-light text primitives shared across the sub-detectors and
the orchestrator. Mirrors :mod:`modules.ai_detection.utils` -- this
sub-system is passive-only, so there is nothing here that performs I/O.
